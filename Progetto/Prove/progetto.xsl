                ...
                <div id="fonte-primaria" class="box-grande">
                    ...
                    <h2><xsl:text>La fonte primaria</xsl:text></h2>
                        <div class="box-contenitore">
                            ...
                            <span class="affiancato">
                                <h3><xsl:text>Trascrizione della prima pagina</xsl:text></h3>
                        ...
                        <div class="box-contenitore">
                            ...
                            <span class="affiancato">
                                <h3><xsl:text>Trascrizione della seconda pagina</xsl:text></h3>
                        ...
                        <div class="box-contenitore">
                            ...
                            <span class="affiancato">
                                <h3><xsl:text>Trascrizione della terza pagina</xsl:text></h3>
...
<xsl:template match="tei:surface[@xml:id='ms_fr_03951_07_p003']/tei:graphic">
    ...
    <!-- template per collegamento al facsimile ################ NON FUNZIONA RIVEDERE #####################-->
