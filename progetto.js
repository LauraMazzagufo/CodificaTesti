...
$(document).ready(function() {
    // Seleziona il paragrafo in francese
    $("#p1-fr").hover(
        function() {
            // Quando il mouse entra nel paragrafo francese

            // Evidenzia il testo in italiano
            $("#p1-it").addClass("highlight");
        },
        function() {
            // Quando il mouse esce dal paragrafo francese

            // Rimuovi la classe "highlight" dal testo in italiano
            $("#p1-it").removeClass("highlight");
        }
    );
  });